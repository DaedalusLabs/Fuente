    ...
    html! {
        <main class="container mx-auto overflow-hidden">
            <div class="flex flex-col h-full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 p-5 lg:p-0 lg:px-5">
                    <div class="rounded-2xl admin-shadow flex items-center justify-center gap-5 p-3 border-l-[30px] border-l-fuente">
                        <div>
                    ...
                    <div class="rounded-2xl admin-shadow flex items-center justify-center gap-5 p-3 border-l-[30px] border-l-lime-500">
                        <div>
                    ...
                    <div class="rounded-2xl admin-shadow flex items-center justify-center gap-5 p-3 border-l-[30px] border-l-red-500">
                        <div>
